package de.owsianowski.material;
...
public class seite2 extends Activity implements B4AActivity{
	public static seite2 mostCurrent;
...
public de.owsianowski.material.main _main = null;
public de.owsianowski.material.starter _starter = null;
...
public static String  _activity_create(boolean _firsttime) throws Exception{
 ...
 //BA.debugLineNum = 21;BA.debugLine="Activity.LoadLayout(\"Page2\")";
mostCurrent._activity.LoadLayout("Page2",mostCurrent.activityBA);
...
public static String  _button2_click() throws Exception{
 //BA.debugLineNum = 34;BA.debugLine="Sub Button2_Click";
...
public static String  _globals() throws Exception{
 ...
 //BA.debugLineNum = 16;BA.debugLine="Private Button2 As Button";
